...
class DS2SVMPredictor:
    ...
    def preprocess_data(self):
        ...
        numeric_data = self.df2[numeric_columns]
        ...
        categorical_data = self.df2[categorical_columns]
        ...
        categorical_data_imputed[self.target_column] = categorical_data_imputed[self.target_column]
    ...
    def train_model(self, model_path=None):
        X = self.preprocessed_data.drop("VITAL_STATUS", axis=1)  # Features
        y = self.preprocessed_data["VITAL_STATUS"]  # Target variable
        ...
        model = svm_model.fit(X_train, y_train) #  Learns the parameters of the SVM model to best separate the data into different classes.
    ...
    def predict(self, row, model_path=None):
        ...
        return self.model.predict(row_preprocessed)
